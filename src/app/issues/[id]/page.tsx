...
import { ArrowLeft, Trash2, Calendar, User, Folder, Tag, Hash } from "lucide-react";
      ...
      <div className="flex-1 space-y-6">
        ...
        <div className="space-y-2">
          ...
          <Textarea
            ...
            onBlur={() => handleUpdateField('description', localDescription)}
            placeholder="Add a description..."
            className="min-h-[200px] w-full resize-none border-none bg-zinc-900/30 p-4 text-zinc-300 shadow-none focus-visible:ring-1 focus-visible:ring-zinc-800"
          />
        </div>
